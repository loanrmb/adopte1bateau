...
───────────────────────────── */
const MODELS = [
  { name: 'Cap Serein',     price: '90 €'  },
  { name: 'Horizon Sport',  price: '120 €' },
  { name: 'Prestige 400',   price: '180 €' },
];
...
$('submitBtn').addEventListener('click', async function () {
  ...
  [$('fName'), $('fEmail')].forEach(f => { f.style.borderColor = f.value.trim() ? '' : '#ff453a'; });
